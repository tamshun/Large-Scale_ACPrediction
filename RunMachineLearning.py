...
from Interpretation.func_shap          import SHAP_explainability
...
if __name__ == "__main__":
    ...
    bd    = '/Users/tamura/work/ACPredCompare'#"/home/tamura/work/ACPredCompare/"
    model = "svm"
    mtype = "MMPkernel"
    os.chdir(bd)
    ...
    for i, sr in tlist.iterrows():
        ...
        # p = ReCalc_SHAP(modeltype   = mtype,
        #                 model       = model,
        #                 dir_log     = "./ForThrombin/Log/%s" %mtype,
        #                 dir_score   = "./ForThrombin/Score/%s" %mtype,
        #                 interpreter = "shap",
        #                 aconly      = False,
        #                 kernel_type = False)
