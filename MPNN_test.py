...
if __name__ == '__main__':
    ...
    data = pd.read_csv('./Dataset/CGR/CHEMBL4072.tsv', sep='\t', index_col=0)
    ...
    args = {"train_num": 50,
            ...
            "step_num": 3,
            "DNNLayerNum": 3,
            "batch_prop": 0.01708598864140563,
            "step_size": 16,
            "grad_node": 33,
            "node_list": [100, 67, 34, 1],
            }
    
    mol  = MolGraph(cgr, args=args)
    mol  = BatchMolGraph([mol])
    mpnn = MPNEncoder(args=args)
    out  = mpnn.forward(mol)